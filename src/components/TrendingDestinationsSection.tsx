...
const DESTINATIONS: Destination[] = [
    { id: 3, city_name: 'Tokyo', country_code: 'JP', description: 'Vibrant culture meets futuristic skyline.' },
    { id: 4, city_name: 'Paris', country_code: 'FR', description: 'The city of love, lights, and art.' },
    { id: 2, city_name: 'New York', country_code: 'US', description: 'The city that never sleeps.' },
    { id: 5, city_name: 'Rome', country_code: 'IT', description: 'Ancient history and delicious pasta.' },
];
                                ...
                                <div className="p-4 md:p-6 flex flex-col flex-grow"> {/* Added flex flex-col flex-grow */}
                                    ...
                                    {cityImg && (
                                        <div className="text-xs text-gray-500 mb-2 text-center">
                                            Photo by{' '}
                                            <a href={cityImg.photographer_profile_url} target="_blank" rel="noopener noreferrer" className="underline">
                                                {cityImg.photographer_name}
                                            </a>{' '}
                                            on{' '}
                                            <a href={cityImg.unsplash_page_url} target="_blank" rel="noopener noreferrer" className="underline">
                                                Unsplash
                                            </a>
                                        </div>
                                    )}
